...
ref_m = []
s = []
f = open("E:\\Bio\\workrectify\\63089\\gene_63089_raw_normal.txt")
flag = 0
n = 0
for p in f:
    flag += 1
...
for k in range(19,50):
    fw = open("E:\\Bio\\workrectify\\27342\\ref_27_63_0.01\\" + str(k) + "_63_value.txt", "w")
    for s in range(len(genes)):
        sample_m.append(ref_1[genes[s]] + [sample[genes[s]][0]])
